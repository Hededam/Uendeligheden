...
namespace Valve.VR.InteractionSystem
{
	...
	public class GunHand : MonoBehaviour
	{
        ...
        private bool nocked = true;
        public GrabTypes nockedWithType = GrabTypes.None;
        ...
        */
        ...
        private void HandAttachedUpdate(Hand hand)
        {
            ...
            //if (hand.IsGrabbingWithType(nockedWithType) == GrabTypes.None)
            //if (GrabTypes.None)
            if (nocked && hand.IsGrabbingWithType(nockedWithType) == false)
            {
                FireArrow();
		...
		{
			bow = hand.otherHand.GetComponentInChildren<GunHand>();
		}*/       
	}
}
